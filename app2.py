...
TWILIO_ACCOUNT_SID = 'ACd1d01354dcbfe50658543240a92cd774'
TWILIO_AUTH_TOKEN =  '471f184d76071e91acf7168dd33c1688'
TWILIO_PHONE_NUMBER = '+918513919367'
verify_sid = "VA41c160787875a3b27cf3f481063a1814"
    ...
    if request.method == 'POST':
        ...
        if accPass is None:
            ...
            if sha256_crypt.verify(candidate, accPass):
                ...
                .verification_checks \
                .create(to=TWILIO_PHONE_NUMBER, code=otp)
...
def send_code():
    ...
    # Verify the username and password (you can replace this with your own logic)
  ...
  .create(to=TWILIO_PHONE_NUMBER, channel="sms")
        ...
        flash('Authentication code sent via SMS!','Yayyy!')
    else:
